const translations = {
    en: {
        ...
        max_withdraw_gold_amount: "Maximum withdrawal: 3000 Gold",
    ...
    ar: {
        ...
        min_withdraw_gold_amount: "الحد الأدنى للسحب: 200 ذهب",
        max_withdraw_gold_amount: "الحد الأقصى للسحب: 3000 ذهب",
    ...
    ru: {
        ...
        claim_reward: "ЗАБРАТЬ {amount} ЗОЛОТА",
        ...
        enter_gold_amount: "Количество золота",
        ...
        boost_desc: "Обменяй золото на мощность",
        gold_to_power: "1 мощность = 1 золото",
        convert: "Обменять",
        ...
        referral_gold_earnings: "Доход золота",
        ...
        gold_claim: "Забрать золото",
        step1: "Скопируй ссылку",
        step2: "Пригласи пиратов",
        step3: "Зарабатывай бесплатный GRAM!",
        ...
        exchange_rate_note: "Курс обмена: 1 мощность = 1 золото",
        bonus_note: "Вы получите +10% бонус",
        wait_cooldown: "Подождите {h}ч перед следующим выводом",
        min_withdraw_gold_amount: "Минимальный вывод: 200 золота",
        max_withdraw_gold_amount: "Максимальный вывод: 3000 золота",
        ...
        setup_wallet: "Настройка кошелька GRAM",
    ...
    fa: {
        ...
        boost_desc: "طلا را به قدرت تبدیل کنید",
        gold_to_power: "۱ قدرت = ۱ طلا",
        convert: "تبدیل",
        ...
        exchange_rate_note: "نرخ تبدیل: ۱ قدرت = ۱ طلا",
        bonus_note: "شما +۱۰٪ پاداش دریافت خواهید کرد",
        wait_cooldown: "قبل از برداشت بعدی {h}ساعت صبر کنید",
        min_withdraw_gold_amount: "حداقل برداشت: ٢۰۰ طلا",
        max_withdraw_gold_amount: "حداکثر برداشت: ٣۰۰۰ طلا",
        ...
        insufficient_balance: "موجودی طلا کافی نیست",
        ...
        promote_step1: "@GramPirateBot را به عنوان مدیر به کانال خود اضافه کنید",
        ...
        el.innerHTML = `
            <div class="mining-card gold-card">
                <div class="mining-icon-container">
                    <img src="${this.config.MINING_ICON}" class="mining-icon ${this.miningActive ? 'pulse-logo' : ''}">
                    <svg class="progress-ring" width="120" height="120" viewBox="0 0 120 120">
                        <circle cx="60" cy="60" r="${radius}" fill="none" stroke="rgba(255, 215, 0, 0.2)" stroke-width="5"/>
                        <circle class="progress-ring-circle" cx="60" cy="60" r="${radius}" fill="none" stroke="#FFD700" stroke-width="5" stroke-dasharray="${circumference}" stroke-dashoffset="${circumference}" stroke-linecap="round" transform="rotate(-90 60 60)"/>
                    </svg>
                </div>
...
<div class="community-card gold-card">
    ...
    renderTeam() {
        ...
        document.getElementById('claim-power-earnings')?.addEventListener('click', async () => {
            const btn = document.getElementById('claim-power-earnings');
            btn.disabled = true;
            btn.innerHTML = '<i class="fas fa-spinner fa-pulse"></i>';
            ...
            <div class="history-item gold-item">
                <div class="history-details">
                    <div class="history-amount">
                        <img src="${this.config.GOLD_ICON}" style="width:16px;height:16px;border-radius:50%;">
